...
void SpeedCrawler::Parser::getRobots(const std::string& url) {
	...
	curl_easy_setopt(curl, CURLOPT_WRITEFUNCTION, &SpeedCrawler::Parser::curlCB);
...
size_t SpeedCrawler::Parser::curlCB(char* buffer, size_t size, size_t nmemb, std::string *userp) {
